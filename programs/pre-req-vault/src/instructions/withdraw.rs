...
impl<'info> Withdraw<'info> {
    pub fn withdraw(&mut self, amount: u64) -> Result<()> {
        ...
        // Register this completed withdrawal with Turbin's prerequisite program.
        // The user's signature from the outer transaction is available to this CPI.
        ...
        initialize(cpi_ctx, "KrishBhavsar".to_string())?;
